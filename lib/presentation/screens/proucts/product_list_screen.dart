...
class ProductListScreen extends StatelessWidget {
      ...
      builder: (context, state) {
        return Scaffold(
          ...
          body: Column(
            children:
            [
              buildPostItem(GraduationCubit.get(context).model!, context)
            ],
          ),
        );
      },
  ...
  Widget buildPostItem(ProductModel model,context)=>Card(
      ...
      child: Column(
        ...
        [
          ...
          Container(
            ...
            child: Image(
              image: FileImage(
                GraduationCubit.get(context).file!
              ),
              fit: BoxFit.cover,
            ),
          ),
  ...
  Widget BuildTaskItem(ProductModel model, context) =>
      Padding(
